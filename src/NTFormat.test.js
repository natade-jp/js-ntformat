...
test("NTFormat.datef 1", () => {
	...
	expect(NTFormat.datef("YYYY-MM-DDThh:mm:ssZ", day, { is_utc: true })).toBe("2023-01-23T03:34:56Z");
	expect(NTFormat.datef("YYYY-MM-DDThh:mm:sszzzzzz", day, { timezone_minutes: 9 * 60 })).toBe(
		"2023-01-23T12:34:56+09:00"
	);
	expect(NTFormat.datef("YYYY-MM-DDThh:mm:sszzzzzz", day, { timezone_minutes: -510 })).toBe(
		"2023-01-23T12:34:56-08:30"
	);
});

test("NTFormat.datef 2", () => {
	expect(
		NTFormat.datef("YYYY-MM-DDThh:mm:sszzzzzz", new Date("2023-01-23T12:34:56+02:00"), { timezone_minutes: 9 * 60 })
	).toBe("2023-01-23T19:34:56+09:00");
	expect(NTFormat.datef("YYYY-MM-DDThh:mm:ssZ", new Date("2023-01-23T12:34:56+02:00"), { is_utc: true })).toBe(
